...
{
public:
    PeerAddress() : mTransportType(Type::kUndefined), mId{ .mRemoteId = kUndefinedNodeId } {}
    PeerAddress(const Inet::IPAddress & addr, Type type) :
...
private:
    ...
    Inet::InterfaceId mInterface = InterfaceIdNull()();
