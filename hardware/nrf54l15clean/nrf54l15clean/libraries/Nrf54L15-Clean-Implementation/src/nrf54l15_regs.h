...
constexpr uint32_t AAR00_BASE = static_cast<uint32_t>(NRF_AAR00_BASE);
constexpr uint32_t CCM00_BASE = static_cast<uint32_t>(NRF_CCM00_BASE);
constexpr uint32_t ECB00_BASE = static_cast<uint32_t>(NRF_ECB00_BASE);
constexpr uint32_t CRACEN_BASE = static_cast<uint32_t>(NRF_CRACEN_BASE);
constexpr uint32_t CRACENCORE_BASE = static_cast<uint32_t>(NRF_CRACENCORE_BASE);
constexpr uint32_t SPIS00_BASE = static_cast<uint32_t>(NRF_SPIS00_BASE);
