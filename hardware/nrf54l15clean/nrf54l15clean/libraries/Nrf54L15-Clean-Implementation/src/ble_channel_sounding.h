...
struct BleCsVprMeasurementWorkItem {
  ...
  uint32_t nextPeerStageHeartbeat = 0U;
  uint32_t nextChunkStageHeartbeat = 0U;
  uint16_t controllerAutoBlockMask = 0U;
  uint32_t controllerAutoCount = 0U;
  uint32_t controllerAutoServiceCalls = 0U;
  uint32_t controllerAutoDuePasses = 0U;
  uint16_t controllerAutoProcedureCounter = 0U;
  uint8_t controllerAutoSubevent = 0xFFU;
  uint8_t controllerAutoStatus = 0xFFU;
...
struct BleCsVprMeasurementExecutionResult {
  ...
  uint32_t rfTimedMode2Token = 0U;
  uint32_t rfTimedMode2TxWaitLoops = 0U;
  uint32_t rfTimedMode2GapWaitLoops = 0U;
  uint32_t rfTimedMode2RxReadyWaitLoops = 0U;
  uint32_t rfTimedMode2ListenWaitLoops = 0U;
  uint32_t rfTimedMode2DisableWaitLoops = 0U;
  uint32_t rfTimedMode2StateAfter = 0U;
  uint32_t rfTimingOwnerToken = 0U;
  uint32_t rfTimingOwnerHeartbeat = 0U;
  uint32_t rfTimingOwnerNextProcedureHeartbeat = 0U;
  uint32_t rfTimingOwnerNextSubeventHeartbeat = 0U;
  uint32_t rfTimingOwnerProcedureIntervalTicks = 0U;
  uint32_t rfTimingOwnerSubeventDelayTicks = 0U;
  uint16_t rfPacketControlToProbeDelayUs = 0U;
  uint16_t rfPacketResponseListenWindowUs = 0U;
  uint16_t rfTimingOwnerProcedureCounter = 0U;
  uint16_t rfTimingOwnerConnHandle = 0U;
  ...
  bool rfTimedMode2Valid = false;
  bool rfTimedMode2TokenValid = false;
  bool rfTimedMode2TxReady = false;
  bool rfTimedMode2TxEnd = false;
  bool rfTimedMode2RxReady = false;
  bool rfTimedMode2RxEnd = false;
  bool rfTimedMode2Disabled = false;
  bool rfTimedMode2TimingApplied = false;
  bool rfTimedMode2PacketPtrRestored = false;
  bool rfTimingOwnerValid = false;
  bool rfTimingOwnerTokenValid = false;
  bool rfTimingOwnerProcedureActive = false;
  bool rfTimingOwnerProcedureIntervalComputed = false;
  bool rfTimingOwnerSubeventDelayComputed = false;
  bool rfTimingOwnerConnectedSchedule = false;
  bool rfTimingOwnerControllerSnapshot = false;
  bool rfPacketParamsValid = false;
  bool rfPacketParamsControllerOwned = false;
  bool rfPacketParamsCteInfoIncludesType = false;
  ...
  uint8_t rfTimedMode2Version = 0U;
  uint8_t rfTimedMode2Flags = 0U;
  uint8_t rfTimedMode2Status = 0xFFU;
  uint8_t rfTimedMode2Channel = 0xFFU;
  uint8_t rfTimingOwnerVersion = 0U;
  uint8_t rfTimingOwnerFlags = 0U;
  uint8_t rfTimingOwnerStatus = 0xFFU;
  uint8_t rfTimingOwnerActiveSubevent = 0U;
  uint8_t rfTimingOwnerPeerGapTicks = 0U;
  uint8_t rfTimingOwnerIntervalSelector = 0U;
  uint8_t rfPacketParamsVersion = 0U;
  uint8_t rfPacketParamsFlags = 0U;
  uint8_t rfPacketS0 = 0U;
  uint8_t rfPacketCteInfo = 0U;
  uint8_t rfPacketPayloadLen = 0U;
  uint8_t rfPacketMagic0 = 0U;
  uint8_t rfPacketMagic1 = 0U;
  uint8_t rfPacketType = 0U;
  uint8_t rfPacketSequence = 0U;
  uint8_t rfPacketChannel = 0xFFU;
...
struct BleCsConnectedMode2SweepResult {
  ...
  bool workRfTimingOwnerOk = false;
  ...
  uint16_t workRfPacketControlToProbeDelayUs = 0U;
  uint16_t workRfPacketResponseListenWindowUs = 0U;
  uint32_t workRfTimedMode2Token = 0U;
  uint32_t workRfTimedMode2TxWaitLoops = 0U;
  uint32_t workRfTimedMode2GapWaitLoops = 0U;
  uint32_t workRfTimedMode2RxReadyWaitLoops = 0U;
  uint32_t workRfTimedMode2ListenWaitLoops = 0U;
  uint32_t workRfTimedMode2DisableWaitLoops = 0U;
  uint32_t workRfTimedMode2StateAfter = 0U;
  uint32_t workRfTimingOwnerToken = 0U;
  uint32_t workRfTimingOwnerHeartbeat = 0U;
  uint32_t workRfTimingOwnerNextProcedureHeartbeat = 0U;
  uint32_t workRfTimingOwnerNextSubeventHeartbeat = 0U;
  uint32_t workRfTimingOwnerProcedureIntervalTicks = 0U;
  uint32_t workRfTimingOwnerSubeventDelayTicks = 0U;
  ...
  uint8_t workRfPacketS0 = 0U;
  uint8_t workRfPacketCteInfo = 0U;
  uint8_t workRfPacketPayloadLen = 0U;
  uint8_t workRfPacketMagic0 = 0U;
  uint8_t workRfPacketMagic1 = 0U;
  uint8_t workRfPacketType = 0U;
  uint8_t workRfPacketSequence = 0U;
  uint8_t workRfPacketChannel = 0xFFU;
  uint8_t workRfTimedMode2Status = 0xFFU;
  uint8_t workRfTimedMode2Flags = 0U;
  uint8_t workRfTimedMode2Channel = 0xFFU;
  uint8_t workRfTimingOwnerStatus = 0xFFU;
  uint8_t workRfTimingOwnerFlags = 0U;
  uint8_t workRfTimingOwnerSubevent = 0U;
  uint8_t workRfTimingOwnerPeerGapTicks = 0U;
  uint8_t workRfTimingOwnerIntervalSelector = 0U;
