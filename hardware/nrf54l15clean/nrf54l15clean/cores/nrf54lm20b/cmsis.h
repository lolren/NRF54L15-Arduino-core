 ...
 *
 * CMSIS-Core Compatibility Header for nRF54LM20A.
 */
...
typedef struct {
    ...
    volatile uint8_t  IP[271U];           /*!< Interrupt Priority Register */
    uint8_t RESERVED5[0xE00U - 0x300U - 271U];
...
#define SERIAL23_IRQn SPIM23_IRQn
